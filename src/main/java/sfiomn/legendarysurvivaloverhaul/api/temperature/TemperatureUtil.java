...
public class TemperatureUtil
{
	 ...
	 */
	public static boolean hasImmunity(PlayerEntity player, TemperatureImmunityEnum immunity)
	{
	 ...
	 * @param immunity Temperature immunity
	 */
	public static void addImmunity(PlayerEntity player, TemperatureImmunityEnum immunity)
	{
	 ...
	 * @param immunity Temperature immunity
	 */
	public static void removeImmunity(PlayerEntity player, TemperatureImmunityEnum immunity)
	{
	 ...
	 */
	public static void addTemperatureModifier(PlayerEntity player, double temperature, UUID uuid) {
	 ...
	 * @param uuid Uuid of the modifier, necessary to remove the modifier when not used anymore
	 */
	public static void addHeatResistanceModifier(PlayerEntity player, double resistance, UUID uuid) {
	 ...
	 * @param uuid Uuid of the modifier, necessary to remove the modifier when not used anymore
	 */
	public static void addColdResistanceModifier(PlayerEntity player, double resistance, UUID uuid) {
	 ...
	 * @param uuid Uuid of the modifier, necessary to remove the modifier when not used anymore
	 */
	public static void addThermalResistanceModifier(PlayerEntity player, double resistance, UUID uuid) {
