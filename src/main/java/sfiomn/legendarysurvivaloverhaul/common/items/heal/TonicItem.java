...
public class TonicItem extends BodyHealingItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltips, TooltipFlag isAdvanced) {
        ...
        ItemStack potionEquivalent = PotionUtils.setCustomEffects(new ItemStack(ItemRegistry.TONIC.get()), Collections.singletonList(new MobEffectInstance(MobEffects.REGENERATION, 400, 1)));
