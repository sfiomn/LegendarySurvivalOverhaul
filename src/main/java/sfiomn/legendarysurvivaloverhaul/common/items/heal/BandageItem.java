...
public class BandageItem extends BodyHealingItem {
    ...
    public void runSecondaryEffect(PlayerEntity player, ItemStack stack) {
        player.addEffect(new EffectInstance(Effects.REGENERATION, Config.Baked.bandageRegenerationTickDuration, Config.Baked.bandageRegenerationAmplifier));
    ...
    public void appendHoverText(ItemStack stack, @Nullable World world, List<ITextComponent> tooltips, ITooltipFlag isAdvanced) {
        ...
        addSecondaryEffectTooltip(tooltips, new EffectInstance(Effects.REGENERATION, Config.Baked.bandageRegenerationTickDuration, Config.Baked.bandageRegenerationAmplifier));
    }
}
