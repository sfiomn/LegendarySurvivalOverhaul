...
public class EffectRegistry {
    ...
    public static final RegistryObject<Effect> HEAT_RESISTANCE = EFFECTS.register("heat_resistance", () -> new SimpleAttributeEffect(EffectType.BENEFICIAL, 16420407, 1).addAttributeModifier(AttributeRegistry.HEAT_RESISTANCE.get(), SimpleAttributeEffect.HEAT_RESISTANCE_ATTRIBUTE_UUID, 1.0, AttributeModifier.Operation.ADDITION));
    public static final RegistryObject<Effect> COLD_RESISTANCE = EFFECTS.register("cold_resistance", () -> new SimpleAttributeEffect(EffectType.BENEFICIAL, 6466303, 1).addAttributeModifier(AttributeRegistry.COLD_RESISTANCE.get(), SimpleAttributeEffect.COLD_RESISTANCE_ATTRIBUTE_UUID, 1.0, AttributeModifier.Operation.ADDITION));
    ...
    public static final RegistryObject<Potion> HEAT_RESISTANCE_POTION = POTIONS.register("heat_resistance", () -> new Potion("heat_resistance", new EffectInstance(HEAT_RESISTANCE.get(), 1800, 1, false, true, true)));
    public static final RegistryObject<Potion> HEAT_RESISTANCE_POTION_LONG = POTIONS.register("heat_resistance_long", () -> new Potion("heat_resistance_long", new EffectInstance(HEAT_RESISTANCE.get(), 2400, 1, false, true, true)));
    public static final RegistryObject<Potion> COLD_RESISTANCE_POTION = POTIONS.register("cold_resistance", () -> new Potion("cold_resistance", new EffectInstance(COLD_RESISTANCE.get(), 1800, 1, false, true, true)));
    public static final RegistryObject<Potion> COLD_RESISTANCE_POTION_LONG = POTIONS.register("cold_resistance_long", () -> new Potion("cold_resistance_long", new EffectInstance(COLD_RESISTANCE.get(), 2400, 1, false, true, true)));
    ...
    public static void registerBrewingRecipes() {
        ...
        addBrewingRecipe(Potions.AWKWARD, ItemRegistry.ICE_FERN_GOLD.get(), COLD_IMMUNITY_POTION.get());
    ...
    private static void addBrewingRecipe(Potion potionInput, Item ingredient, Potion potionResult) {
        BrewingRecipeRegistry.addRecipe(new LSOBrewingRecipe(PotionUtils.setPotion(new ItemStack(Items.POTION), potionInput), NBTIngredient.of(new ItemStack(ingredient)), PotionUtils.setPotion(new ItemStack(Items.POTION), potionResult)));
    }
    ...
    private static class LSOBrewingRecipe extends BrewingRecipe {

        private ItemStack input;

        public LSOBrewingRecipe(ItemStack input, Ingredient ingredient, ItemStack output) {
            super(NBTIngredient.of(input), ingredient, output);
            this.input = input;
        }

        @Override
        public boolean isInput(@Nonnull ItemStack stack) {
            return super.isInput(stack) && potionsAreEqual(stack);
        }

        private boolean potionsAreEqual(ItemStack stack) {
            return PotionUtils.getPotion(stack).equals(PotionUtils.getPotion(this.input));
        }
    }
}
